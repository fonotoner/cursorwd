...
$resolutions   = array(1024, 768, 480); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "sandbox/ai-cache"; // where to store the generated re-sized images. Specify from your document root!
